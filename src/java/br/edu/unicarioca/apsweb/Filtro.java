 ...
 * @author Marco
 */
@WebFilter(filterName = "Filtro", urlPatterns = {"/tabela.jsp, /alterar.jsp, /cadastro.jsp, /excluir.do, /salvar.do"})
public class Filtro implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        long tempo = (Integer)sessao.getAttribute("tempo");
        long tempoagora = System.currentTimeMillis()/1000;
        long temposessao = tempoagora - tempo;
